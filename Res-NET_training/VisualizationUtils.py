...
if __name__ == "__main__":
    ...
    add_cifar_images_with_progress(num_images=50, first_image_index=0, output_folder=generated_folder)

    # Create a dataset for the generated images
    generated_dataset = CustomObjectDetectionDataset(generated_folder)

    # Visualize predictions on the generated images
    visualize_predictions(model, generated_dataset, num_images_to_show=3, score_threshold=0.5)