...
YOLO_TRAIN_PARAMS = {
    ...
    'mosaic': 0.2,        # Обов'язково! Створює сцени з об'єктами різних розмірів.
    'mixup': 0.05,         # Змішування зображень для кращої генералізації.
    'copy_paste': 0.0,    # Дуже ефективно для збільшення кількості об'єктів на зображенні.
    'scale': 0.5,         # Дозволяє випадково масштабувати зображення до 50%.
    # --- Геометричні аугментації ---
    'degrees': 15.0,      # Випадкові повороти.
    'translate': 0.1,     # Випадкові зсуви.
    'shear': 5.0,         # Нахили.
    'flipud': 0.5,        # Вертикальні перевертання (якщо це доречно для ваших даних).
    'fliplr': 0.3,        # Горизонтальні перевертання (стандартно).
}
