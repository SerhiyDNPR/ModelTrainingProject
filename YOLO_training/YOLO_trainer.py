...
if __name__ == '__main__':
    ...
    #model = YOLO("../runs/train05/UFO_training_tensorboard/weights/best.pt")  

    # Train the model
    model.train(
        data='yolo_config.yaml',       # dataset config
        epochs=50,
        imgsz=1024, #640, 1280, 1536, 1792, 2048 
        batch=16,
        project='runs/train05',           # default path for logs
    ...
    model.save("UFO_detector_home_PC.pt")
